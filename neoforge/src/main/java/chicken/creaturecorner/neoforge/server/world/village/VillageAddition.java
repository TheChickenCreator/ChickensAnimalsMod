package chicken.creaturecorner.neoforge.server.world.village;
...
@EventBusSubscriber(modid = CCConstants.MOD_ID)
public class VillageAddition {
    ...
    public static void addNewVillageBuilding(ServerAboutToStartEvent event) {
        ...
        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                ResourceLocation.fromNamespaceAndPath("minecraft","village/common/cats"),
                "creaturecorner:village/pigeon_orange", 5);

        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                ResourceLocation.fromNamespaceAndPath("minecraft","village/common/cats"),
                "creaturecorner:village/pigeon_white", 5);

        addBuildingToPool(templatePoolRegistry, processorListRegistry,
                ResourceLocation.fromNamespaceAndPath("minecraft","village/common/cats"),
                "creaturecorner:village/pigeon_grey", 5);
