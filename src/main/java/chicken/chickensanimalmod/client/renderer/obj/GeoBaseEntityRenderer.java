package chicken.chickensanimalmod.client.renderer.obj;
        ...
        super(renderManager, new GeoModel<>() {
            ...
            public ResourceLocation getModelResource(GeoEntityBase animatable) {
                ...
                if (animatable.hasChildModel() && animatable.isBaby()) {
                    return ResourceLocation.fromNamespaceAndPath(AnimalMod.MODID, "geo/animal/" + entityName + "/" + entityName + "_baby.geo.json");
                } else {
                    return ResourceLocation.fromNamespaceAndPath(AnimalMod.MODID, "geo/animal/" + entityName + "/" + entityName + ".geo.json");
                }
            }
            ...
            public ResourceLocation getTextureResource(GeoEntityBase animatable) {
                ...
                if (animatable.hasChildModel() && animatable.isBaby()) {
                    return ResourceLocation.fromNamespaceAndPath(AnimalMod.MODID, "textures/animal/" + entityName + "/" + entityName + (animatable.childVariants() ? variantName : "") + "_baby.png");
                } else {
                    return ResourceLocation.fromNamespaceAndPath(AnimalMod.MODID, "textures/animal/" + entityName + "/" + entityName + variantName + ".png");
                }
            }
            ...
            public ResourceLocation getAnimationResource(GeoEntityBase animatable) {
                String entityName = entityHolder.name();
                if (animatable.hasChildModel() && animatable.isBaby()) {
                    return ResourceLocation.fromNamespaceAndPath(AnimalMod.MODID, "animations/animal/" + entityName + "/" + entityName + "_baby.animation.json");
                } else {
                    return ResourceLocation.fromNamespaceAndPath(AnimalMod.MODID, "animations/animal/" + entityName + "/" + entityName + ".animation.json");
                }
            }
        });
    }
